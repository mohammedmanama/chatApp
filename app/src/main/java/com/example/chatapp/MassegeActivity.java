...
public class MassegeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MassegeActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        username = findViewById(R.id.userMassage);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MassegeActivity.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if (u.getImageURL().equals("default")){
                        ...
                        Glide.with(getApplicationContext()).load(u.getImageURL()).into(profile_image);
                    }
                    readMessage(fuser.getUid() , userid , u.getImageURL());
                }
            }
    ...
    private void sendNotification(String receiver , final String userid , final String message){
                        ...
                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                            if(response.code() == 200){
                                if (response.body().success != 1){
                                    Toast.makeText(MassegeActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    messageAdapter = new MessageAdapter(MassegeActivity.this , mchat , imageurl);
